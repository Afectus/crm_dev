...
class Form_user_restore(forms.Form):
	phone = forms.CharField(label='Номер телефона (8XXXXXXXXXX)', help_text='Укажите номер телефона, начинается с 8', widget=forms.TextInput(attrs={'class': 'form-control','autocomplete': 'on'}), max_length=11, required=True, validators=[validate_phone_isuse])
