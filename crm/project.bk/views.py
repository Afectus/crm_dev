...
class projectstep_add(CreateView):
    model = projectstep
    template_name = '_edit2.html'
    fields = ['projectstep', 'name', 'executor', 'edate', 'desc']
...
class projectstep_edit(UpdateView):
    model = projectstep
    template_name = '_edit2.html'
    fields = ['id', 'name', 'executor', 'edate', 'desc']
...
# class projectcomment_add(CreateView):
#     model = projectcomment
#     template_name = '_edit2.html'
#     fields = ['value']
#     success_url = '/project/list/'
    ...
    # def dispatch(self, request, *args, **kwargs):
    #     self.data = get_object_or_404(project, id=self.kwargs['pk'], user=self.request.user)
    #     return super(projectcomment_add, self).dispatch(request, *args, **kwargs)
    ...
    #     instance.project = self.data
    #     instance.save()
    #     return super(projectcomment_add, self).form_valid(form)

    # def get_context_data(self, *args, **kwargs):
    #     context_data = super(projectcomment_add, self).get_context_data(*args, **kwargs)
    #     context_data.update({'object': self.data,})
