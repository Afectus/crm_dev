...
class holiday(models.Model):
	...
	user = models.ForeignKey(profileuser, on_delete=models.CASCADE, verbose_name='Сотрудник')
	...
	class Meta:
		ordering=['-edate']
		verbose_name = u'Отпуск сотрудника'
		verbose_name_plural = u'Отпуска сотрудников'
