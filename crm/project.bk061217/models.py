...
class projectstepcost(models.Model):
    ...
    distributor = models.ForeignKey(distributor, verbose_name='Поставщик', blank=True)
...
class projectstep(models.Model):
    ...
    cost = models.ManyToManyField(projectstepcost, verbose_name='Расходы этапа', blank=True)
