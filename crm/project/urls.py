...
urlpatterns = [
	...
	url(r'^project/changestatus/(?P<pk>\d+)/?$', login_required(project_changestatus.as_view()), name='project_changestatus'),
	# url(r'^project/addfile/(?P<pk>\d+)/?$', login_required(FileFieldView.as_view()), name='FileFieldView'),
	url(r'^project/detail/(?P<pk>\d+)/?$', login_required(project_detail.as_view()), name='project_detail'),
	url(r'^project/steps/json/(?P<pk>\d+)/?$', login_required(project_steps_json), name='project_steps_json'),
	...
	url(r'^projectstep/del/(?P<pk>\d+)/?$', login_required(projectstep_del.as_view()), name='projectstep_del'),
	...
	url(r'^projectstep/up/(?P<pk>\d+)/?$', login_required(projectstep_up), name='projectstep_up'),
	url(r'^projectstep/down/(?P<pk>\d+)/?$', login_required(projectstep_down), name='projectstep_down'),
	# url(r'^projectstep/down/(?P<pk>\d+)/?$', login_required(projectstep_down.as_view()), name='projectstep_down'),
	# projectstepcomment
	...
	# projectstepcost
	url(r'^projectstep/cost/add/(?P<pk>\d+)/?$', login_required(projectstep_cost_add.as_view()), name='projectstep_cost_add'),
]
